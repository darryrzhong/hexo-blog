---
title: Android之Rxjava总结指南
date: 2019-09-15 17:01:56
tags: Rxjava
categories: Android
---
...
一个AsyncSubject只在原始Observable完成后，发射来自原始Observable的最后一个值。（如果原始Observable没有发射任何值，AsyncObject也不发射任何值）它会把这最后一个值发射给任何后续的观察者。 ![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.AsyncSubject.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.AsyncSubject.png)

然而，如果原始的Observable因为发生了错误而终止，AsyncSubject将不会发射任何数据，只是简单的向前传递这个错误通知。 ![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.AsyncSubject.e.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.AsyncSubject.e.png)

### BehaviorSubject

当观察者订阅BehaviorSubject时，它开始发射原始Observable最近发射的数据（如果此时还没有收到任何数据，它会发射一个默认值），然后继续发射其它任何来自原始Observable的数据。 ![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.BehaviorSubject.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.BehaviorSubject.png)

然而，如果原始的Observable因为发生了一个错误而终止，BehaviorSubject将不会发射任何数据，只是简单的向前传递这个错误通知。 ![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.BehaviorSubject.e.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.BehaviorSubject.e.png)

### PublishSubject

PublishSubject只会把在订阅发生的时间点之后来自原始Observable的数据发射给观察者。需要注意的是，PublishSubject可能会一创建完成就立刻开始发射数据（除非你可以阻止它发生），因此这里有一个风险：在Subject被创建后到有观察者订阅它之前这个时间段内，一个或多个数据可能会丢失。如果要确保来自原始Observable的所有数据都被分发，你需要这样做：或者使用Create创建那个Observable以便手动给它引入"冷"Observable的行为（当所有观察者都已经订阅时才开始发射数据），或者改用ReplaySubject。 ![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.PublishSubject.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.PublishSubject.png)

如果原始的Observable因为发生了一个错误而终止，PublishSubject将不会发射任何数据，只是简单的向前传递这个错误通知。 ![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.PublishSubject.e.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.PublishSubject.e.png)
...
![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.ReplaySubject.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/S.ReplaySubject.png)
...
![create](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/create.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/create.c.png)
...
![create](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/create.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/create.png)
...
![defer](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/defer.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/defer.c.png)
...
![defer](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/defer.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/defer.png)
...
![switchCase](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/switchCase.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/switchCase.png)

可选包 `rxjava-computation-expressions` 中有一个类似的操作符。`switchCase`操作符有条件的创建并返回一个可能的Observables集合中的一个。

![ifThen](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/ifThen.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/ifThen.png)
...
![from](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/from.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/from.c.png)
...
![from](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/from.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/from.png)
...
- Javadoc: [from(array)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#from(T[]))
...
- Javadoc: [from(Future,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#from(java.util.concurrent.Future, rx.Scheduler))
- Javadoc: [from(Future,timeout, timeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#from(java.util.concurrent.Future, long, java.util.concurrent.TimeUnit))

### RxJavaAsyncUtil

![from func)](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/fromFunc0.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/fromFunc0.png)
...
![from](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.from.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.from.png)
...
![decode](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.decode.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.decode.png)
...
![interval](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/interval.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/interval.c.png)

`Interval`操作符返回一个Observable，它按固定的时间间隔发射一个无限递增的整数序列。

![interval](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/interval.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/interval.png)

RxJava将这个操作符实现为`interval`方法。它接受一个表示时间间隔的参数和一个表示时间单位的参数。

- Javadoc: [interval(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#interval(long, java.util.concurrent.TimeUnit))
- Javadoc: [interval(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#interval(long, java.util.concurrent.TimeUnit rx.Scheduler))

![timer](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timer.p.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timer.p.png)
...
Javadoc: [interval(long,long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#interval(long, long, java.util.concurrent.TimeUnit)) Javadoc: [interval(long,long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#interval(long, long, java.util.concurrent.TimeUnit, rx.Scheduler))
...
![just](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/just.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/just.png)
...
![range](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/range.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/range.png)
...
- Javadoc: [range(int,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#range(int, int))
- Javadoc: [range(int,int,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#range(int, int rx.Scheduler))

## Repeat

创建一个发射特定数据重复多次的Observable

![repeat](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/repeat.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/repeat.c.png)

Repeat重复地发射数据。某些实现允许你重复的发射某个数据序列，还有一些允许你限制重复的次数。

![repeat](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/repeat.o.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/repeat.o.png)
...
- Javadoc: [repeatWhen(Func1,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#repeatWhen(rx.functions.Func1, rx.Scheduler))

### doWhile

![doWhile](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doWhile.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doWhile.png)

`doWhile` 属于可选包`rxjava-computation-expressions`，不是RxJava标准操作符的一部分。`doWhile`在原始序列的每次重复后检查某个条件，如果满足条件才重复发射。

### whileDo

![whileDo](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/whileDo.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/whileDo.png)
...
![Start](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/start.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/start.png)
...
![toAsync](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toAsync.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toAsync.png)
...
![startFuture](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/startFuture.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/startFuture.png)
...
![deferFuture](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/deferFuture.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/deferFuture.png)
...
![fromAction](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/fromCallable.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/fromCallable.png)

`rxjava-async`模块还包含一个`fromAction`操作符，它接受一个`Action`作为参数，返回一个Observable，一旦Action终止，它发射这个你传递给`fromAction`的数据。

### fromCallable

![fromCallable](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/fromCallable.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/fromCallable.png)

`rxjava-async`模块还包含一个`fromCallable`操作符，它接受一个`Callable`作为参数，返回一个发射这个`Callable`的结果的Observable。

### fromRunnable

![fromRunnable](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/fromRunnable.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/fromRunnable.png)

`rxjava-async`模块还包含一个`fromRunnable`操作符，它接受一个`Runnable`作为参数，返回一个Observable，一旦Runnable终止，它发射这个你传递给`fromRunnable`的数据。

### forEachFuture

![forEachFuture](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/forEachFuture.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/forEachFuture.png)
...
![timer](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timer.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timer.png)
...
- Javadoc: [timer(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timer(long, java.util.concurrent.TimeUnit))
- Javadoc: [timer(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timer(long, java.util.concurrent.TimeUnit, rx.Scheduler))
...
![buffer](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer.png)
...
![buffer3](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer3.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer3.png)
...
![buffer4](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer4.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer4.png)
...
- Javadoc: [buffer(int,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(int, int))

### buffer(bufferClosingSelector)

![buffer1](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer1.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer1.png)
...
![buffer8](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer8.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer8.png)
...
- Javadoc: [buffer(Observable,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(rx.Observable, int))

### buffer(bufferOpenings, bufferClosingSelector)

![buffer2](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer2.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer2.png)
...
- Javadoc: [buffer(Observable,Func1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(rx.Observable, rx.functions.Func1))

### buffer(timespan, unit[, scheduler])

![buffer5](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer5.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer5.png)
...
- Javadoc: [buffer(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(long, java.util.concurrent.TimeUnit))
- Javadoc: [buffer(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(long, java.util.concurrent.TimeUnit, rx.Scheduler))

### buffer(timespan, unit, count[, scheduler])

![buffer6](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer6.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer6.png)
...
- Javadoc: [buffer(long,TimeUnit,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(long, java.util.concurrent.TimeUnit, int))
- Javadoc: [buffer(long,TimeUnit,int,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(long, java.util.concurrent.TimeUnit, int, rx.Scheduler))

### buffer(timespan, timeshift, unit[, scheduler])

![buffer7](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer7.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/buffer7.png)
...
- Javadoc: [buffer(long,long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(long, long, java.util.concurrent.TimeUnit))
- Javadoc: [buffer(long,long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#buffer(long, long, java.util.concurrent.TimeUnit, rx.Scheduler))

### buffer-backpressure

你可以使用`Buffer`操作符实现反压`backpressure`（意思是，处理这样一个Observable：它产生数据的速度可能比它的观察者消费数据的速度快）。

![bp.buffer2](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/bp.buffer2.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/bp.buffer2.png)
...
![bp.buffer1](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/bp.buffer1.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/bp.buffer1.png)
...
![flatMap](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/flatMap.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/flatMap.png)
...
![mergeMap](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeMap.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeMap.png)
...
- Javadoc: [flatMap(Func1,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#flatMap(rx.functions.Func1, int))

![mergeMap.nce](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeMap.nce.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeMap.nce.png)

还有一个版本的`flatMap`为原始Observable的每一项数据和每一个通知创建一个新的Observable（并对数据平坦化）。

它也有一个接受额外`int`参数的变体。

- Javadoc: [flatMap(Func1,Func1,Func0)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#flatMap(rx.functions.Func1, rx.functions.Func1, rx.functions.Func0))
- Javadoc: [flatMap(Func1,Func1,Func0,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#flatMap(rx.functions.Func1, rx.functions.Func1, rx.functions.Func0, int))

![mergeMap.r](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeMap.r.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeMap.r.png)

还有一个版本的`flatMap`会使用原始Observable的数据触发的Observable组合这些数据，然后发射这些数据组合。它也有一个接受额外`int`参数的版本。

- Javadoc: [flatMap(Func1,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#flatMap(rx.functions.Func1, rx.functions.Func2))
- Javadoc: [flatMap(Func1,Func2,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#flatMap(rx.functions.Func1, rx.functions.Func2, int))

### flatMapIterable

![mergeMapIterable](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeMapIterable.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeMapIterable.png)
...
- Javadoc: [flatMapIterable(Func1,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#flatMapIterable(rx.functions.Func1, rx.functions.Func2))

### concatMap

![concatMap](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/concatMap.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/concatMap.png)
...
![switchMap](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/switchMap.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/switchMap.png)
...
![St.split](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.split.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.split.png)
...
![groupBy](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/groupBy.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/groupBy.c.png)
...
- Javadoc: [groupBy(Func1,Func1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#groupBy(rx.functions.Func1, rx.functions.Func1))

## Map

对Observable发射的每一项数据应用一个函数，执行变换操作

![map](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/map.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/map.png)
...
![cast](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/cast.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/cast.png)
...
![encode](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.encode.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.encode.png)
...
![byLine](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.byLine.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.byLine.png)
...
![scan](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/scan.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/scan.c.png)
...
![scan](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/scan.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/scan.png)
...
![scanSeed](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/scanSeed.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/scanSeed.png)
...
- Javadoc: [scan(R,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#scan(R, rx.functions.Func2))
...
![window](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window.C.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window.C.png)
...
![window1](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window1.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window1.png)
...
![window2](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window2.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window2.png)
...
- Javadoc: [window(Observable,Func1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#window(rx.Observable, rx.functions.Func1))

### window(count)

![window3](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window3.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window3.png)
...
![window4](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window4.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window4.png)
...
- Javadoc: [window(int,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#window(int, int))

### window(timespan, unit[, scheduler])

![window5](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window5.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window5.png)
...
- Javadoc: [window(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#window(long, java.util.concurrent.TimeUnit))
- Javadoc: [window(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#window(long, java.util.concurrent.TimeUnit, rx.Scheduler))

### window(timespan, unit, count[, scheduler])

![window6](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window6.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window6.png)
...
- Javadoc: [window(long,TimeUnit,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#window(long, java.util.concurrent.TimeUnit, int))
- Javadoc: [window(long,TimeUnit,int,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#window(long, java.util.concurrent.TimeUnit, int, rx.Scheduler))

### window(timespan, timeshift, unit[, scheduler])

![window7](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window7.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/window7.png)
...
- Javadoc: [window(long,long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#window(long, long, java.util.concurrent.TimeUnit))
- Javadoc: [window(long,long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#window(long, long, java.util.concurrent.TimeUnit, rx.Scheduler))

### window-backpressure

你可以使用`Window`操作符实现反压`backpressure`（意思是，处理这样一个Observable：它产生数据的数据可能比它的观察者消费数据的数据快）。

![bp.window1](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/bp.window1.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/bp.window1.png)
...
![bp.window2](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/bp.window2.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/bp.window2.png)
...
![debounce](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/debounce.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/debounce.c.png)
...
![debounce](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/debounce.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/debounce.png)

`throtleWithTimeout/debounce`的一个变体根据你指定的时间间隔进行限流，时间单位通过`TimeUnit`参数指定。

这种操作符默认在`computation`调度器上执行，但是你可以通过第三个参数指定。

- Javadoc: [throttleWithTimeout(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#throttleWithTimeout(long, java.util.concurrent.TimeUnit)) and [debounce(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#debounce(long, java.util.concurrent.TimeUnit))
- Javadoc: [throttleWithTimeout(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#throttleWithTimeout(long, java.util.concurrent.TimeUnit, rx.Scheduler)) and [debounce(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#debounce(long, java.util.concurrent.TimeUnit, rx.Scheduler))

### debounce

![debounce](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/debounce.f.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/debounce.f.png)
...
![distinct](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinct.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinct.c.png)
...
![distinct](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinct.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinct.png)
...
![distinct](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinct.key.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinct.key.png)
...
![distinctUntilChanged](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinctUntilChanged.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinctUntilChanged.png)

RxJava还是实现了一个`distinctUntilChanged`操作符。它只判定一个数据和它的直接前驱是否是不同的。

### distinctUntilChanged(Func1)

![distinctUntilChanged.key](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinctUntilChanged.key.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/distinctUntilChanged.key.png)
...
![elementAt](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/elementAt.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/elementAt.c.png)

`ElementAt`操作符获取原始Observable发射的数据序列指定索引位置的数据项，然后当做自己的唯一数据发射。

![elementAt](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/elementAt.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/elementAt.png)
...
![elementAtOrDefault](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/elementAtOrDefault.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/elementAtOrDefault.png)
...
- Javadoc: [elementAtOrDefault(int,T)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#elementAtOrDefault(int, T))
...
![filter](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/filter.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/filter.c.png)

`Filter`操作符使用你指定的一个谓词函数测试数据项，只有通过测试的数据才会被发射。

![filter](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/filter.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/filter.png)
...
![ofType](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/ofClass.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/ofClass.png)
...
![first](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/first.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/first.c.png)
...
![ignoreElements](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/ignoreElements.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/ignoreElements.c.png)
...
![last](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/last.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/last.c.png)
...
![last](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/last.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/last.png)
...
![last](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/last.p.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/last.p.png)
...
![last](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/lastOrDefault.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/lastOrDefault.png)
...
![last](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/lastOrDefault.p.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/lastOrDefault.p.png)
...
![sample](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sample.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sample.c.png)
...
![sample](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sample.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sample.png)

`sample`(别名`throttleLast`)的一个变体按照你参数中指定的时间间隔定时采样（`TimeUnit`指定时间单位）。

`sample`的这个变体默认在`computation`调度器上执行，但是你可以使用第三个参数指定其它的调度器。

- Javadoc: [sample(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#sample(long, java.util.concurrent.TimeUnit))和[throttleLast(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#throttleLast(long, java.util.concurrent.TimeUnit))
- Javadoc: [sample(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#sample(long, java.util.concurrent.TimeUnit, rx.Scheduler))和[throttleLast(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#throttleLast(long, java.util.concurrent.TimeUnit, rx.Scheduler))

![sample](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sample.o.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sample.o.png)
...
![throttleFirst](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/throttleFirst.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/throttleFirst.png)
...
- Javadoc: [throttleFirst(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#throttleFirst(long, java.util.concurrent.TimeUnit))
- Javadoc: [throttleFirst(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#throttleFirst(long, java.util.concurrent.TimeUnit, rx.Scheduler))

## Skip

抑制Observable发射的前N项数据

![skip](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skip.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skip.c.png)

使用`Skip`操作符，你可以忽略Observable'发射的前N项数据，只保留之后的数据。

![skip](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skip.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skip.png)
...
![skip](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skip.t.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skip.t.png)

`skip`的这个变体接受一个时长而不是数量参数。它会丢弃原始Observable开始的那段时间发射的数据，时长和时间单位通过参数指定。

`skip`的这个变体默认在`computation`调度器上执行，但是你可以使用第三个参数指定其它的调度器。

- Javadoc: [skip(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#skip(long, java.util.concurrent.TimeUnit))
- Javadoc: [skip(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#skip(long, java.util.concurrent.TimeUnit, rx.Scheduler))

## SkipLast

抑制Observable发射的后N项数据

![skipLast](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipLast.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipLast.c.png)

使用`SkipLast`操作符修改原始Observable，你可以忽略Observable'发射的后N项数据，只保留前面的数据。

![skipLast](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipLast.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipLast.png)
...
![skipLast](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipLast.t.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipLast.t.png)
...
- Javadoc: [skipLast(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#skipLast(long, java.util.concurrent.TimeUnit))
- Javadoc: [skipLast(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#skipLast(long, java.util.concurrent.TimeUnit, rx.Scheduler))

## Take

只发射前面的N项数据

![take](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/take.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/take.c.png)

使用`Take`操作符让你可以修改Observable的行为，只返回前面的N项数据，然后发射完成通知，忽略剩余的数据。

![take](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/take.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/take.png)
...
![take](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/take.t.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/take.t.png)

`take`的这个变体接受一个时长而不是数量参数。它会丢发射Observable开始的那段时间发射的数据，时长和时间单位通过参数指定。

`take`的这个变体默认在`computation`调度器上执行，但是你可以使用第三个参数指定其它的调度器。

- Javadoc: [take(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#take(long, java.util.concurrent.TimeUnit))
- Javadoc: [take(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#take(long, java.util.concurrent.TimeUnit, rx.Scheduler))

## TakeLast

发射Observable发射的最后N项数据

![takeLast](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeLast.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeLast.c.png)

使用`TakeLast`操作符修改原始Observable，你可以只发射Observable'发射的后N项数据，忽略前面的数据。

### taskLast.n

![takeLast](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeLast.n.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeLast.n.png)
...
![takeLast](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeLast.t.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeLast.t.png)
...
![takeLast](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeLastBuffer.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeLastBuffer.png)
...
- Javadoc: [takeLastBuffer(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#takeLastBuffer(long, java.util.concurrent.TimeUnit))
- Javadoc: [takeLastBuffer(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#takeLastBuffer(long, java.util.concurrent.TimeUnit, rx.Scheduler))
- Javadoc: [takeLastBuffer(int,long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#takeLastBuffer(int, long, java.util.concurrent.TimeUnit))
- Javadoc: [takeLastBuffer(int,long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#takeLastBuffer(int, long, java.util.concurrent.TimeUnit, rx.Scheduler))
...
![and/then/when](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/and_then_when.C.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/and_then_when.C.png)
...
![and/then/when](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/and_then_when.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/and_then_when.png)
...
![combineLatest](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/combineLatest.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/combineLatest.c.png)
...
![combineLatest](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/combineLatest.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/combineLatest.png)

RxJava将这个操作符实现为`combineLatest`，它接受二到九个Observable作为参数，或者单个Observables列表作为参数。它默认不在任何特定的调度器上执行。

- Javadoc: [combineLatest(List,FuncN)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#combineLatest(java.util.List, rx.functions.FuncN))
- Javadoc: [combineLatest(Observable,Observable,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#combineLatest(rx.Observable, rx.Observable, rx.functions.Func2))

### withLatestFrom

![withLatestFrom](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/withLatestFrom.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/withLatestFrom.png)
...
![join](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/join.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/join.c.png)
...
![groupJoin](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/groupJoin.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/groupJoin.c.png)
...
![join](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/join_.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/join_.png)
...
- Javadoc: [Join(Observable,Func1,Func1,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#join(rx.Observable, rx.functions.Func1, rx.functions.Func1, rx.functions.Func2))

![groupJoin](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/groupJoin.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/groupJoin.png)
...
- Javadoc: [groupJoin(Observable,Func1,Func1,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#groupJoin(rx.Observable, rx.functions.Func1, rx.functions.Func1, rx.functions.Func2))

![st.join](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.join.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/St.join.png)
...
![merge](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/merge.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/merge.c.png)
...
![mergeDelayError](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeDelayError.C.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeDelayError.C.png)
...
![merge](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/merge.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/merge.png)
...
- Javadoc: [merge(Iterable,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#merge(java.lang.Iterable, int))
- Javadoc: [merge(Observable[])](http://reactivex.io/RxJava/javadoc/rx/Observable.html#merge(rx.Observable[]))
- Javadoc: [merge(Observable,Observable)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#merge(rx.Observable, rx.Observable)) (接受二到九个Observable)

除了传递多个Observable给`merge`，你还可以传递一个Observable列表`List`，数组，甚至是一个发射Observable序列的Observable，`merge`将合并它们的输出作为单个Observable的输出：

![merge](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/merge.io.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/merge.io.png)
...
- Javadoc: [merge(Observable)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#merge(rx.Observable))
- Javadoc: [merge(Observable,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#merge(rx.Observable, int))
...
![merge](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeDelayError.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/mergeDelayError.png)
...
- Javadoc: [mergeDelayError(Observable,Observable)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#mergeDelayError(rx.Observable, rx.Observable))

## StartWith

在数据序列的开头插入一条指定的项

![startWith](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/startWith.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/startWith.c.png)

如果你想要一个Observable在发射数据之前先发射一个指定的数据序列，可以使用`StartWith`操作符。（如果你想一个Observable发射的数据末尾追加一个数据序列可以使用`Concat`操作符。）

![startWith](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/startWith.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/startWith.png)
...
![startWith](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/startWith.o.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/startWith.o.png)
...
![switch](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/switch.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/switch.c.png)
...
![zip](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/zip.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/zip.c.png)
...
![zip](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/zip.o.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/zip.o.png)

`zip`的最后一个参数接受每个Observable发射的一项数据，返回被压缩后的数据，它可以接受一到九个参数：一个Observable序列，或者一些发射Observable的Observables。

- Javadoc: [zip(Iterable,FuncN)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#zip(java.lang.Iterable, rx.functions.FuncN))
- Javadoc: [zip(Observable,FuncN)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#zip(rx.Observable, rx.functions.FuncN))
- Javadoc: [zip(Observable,Observable,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#zip(rx.Observable, rx.Observable, rx.functions.Func2)) (最多可以有九个Observables参数)

### zipWith

![zip](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/zip.i.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/zip.i.png)

`zipWith`操作符总是接受两个参数，第一个参数是一个Observable或者一个Iterable。

- Javadoc: [zipWith(Observable,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#zipWith(rx.Observable, rx.functions.Func2))
- Javadoc: [zipWith(Iterable,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#zipWith(java.lang.Iterable, rx.functions.Func2))
...
![catch](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/catch.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/catch.png)
...
![onErrorReturn](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/onErrorReturn.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/onErrorReturn.png)
...
![onErrorResumeNext](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/onErrorResumeNext.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/onErrorResumeNext.png)
...
![onExceptionResumeNext](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/onExceptionResumeNextViaObservable.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/onExceptionResumeNextViaObservable.png)
...
![retry](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/retry.C.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/retry.C.png)
...
![retryWhen](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/retryWhen.f.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/retryWhen.f.png)
...
- Javadoc: [retryWhen(Func1,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#retryWhen(rx.functions.Func1, rx.Scheduler))
...
![delay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delay.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delay.c.png)

`Delay`操作符让原始Observable在发射每项数据之前都暂停一段指定的时间段。效果是Observable发射的数据项在时间上向前整体平移了一个增量。

RxJava的实现是 `delay`和`delaySubscription`。

![delay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delay.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delay.png)
...
- Javadoc: [delay(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#delay(long, java.util.concurrent.TimeUnit))
- Javadoc: [delay()](http://reactivex.io/RxJava/javadoc/rx/Observable.html#delay(long, java.util.concurrent.TimeUnit, rx.Scheduler))

![delay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delay.o.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delay.o.png)
...
![delay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delay.oo.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delay.oo.png)

这个版本的`delay`对每一项数据使用一个Observable作为原始Observable的延时定时器。

这种`delay`默认不在任何特定的调度器上执行。

- Javadoc: [delay(Func0,Func1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#delay(rx.functions.Func0, rx.functions.Func1))

![delay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delaySubscription.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delaySubscription.png)

还有一个操作符`delaySubscription`让你你可以延迟订阅原始Observable。它结合搜一个定义延时的参数。

`delaySubscription`默认在`computation`调度器上执行，你可以通过参数指定使用其它的调度器。

- Javadoc: [delaySubscription(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#delaySubscription(long, java.util.concurrent.TimeUnit))
- Javadoc: [delaySubscription(long,TimeUnit,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#delaySubscription(long, java.util.concurrent.TimeUnit, rx.Scheduler))

![delay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delaySubscription.o.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/delaySubscription.o.png)
...
![do](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/do.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/do.c.png)
...
![doOnEach](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnEach.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnEach.png)
...
![doOnNext](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnNext.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnNext.png)
...
![doOnSubscribe](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnSubscribe.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnSubscribe.png)
...
![doOnUnsubscribe](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnUnsubscribe.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnUnsubscribe.png)
...
![doOnCompleted](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnCompleted.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnCompleted.png)
...
![doOnError](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnError.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnError.png)
...
![doOnTerminate](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnTerminate.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/doOnTerminate.png)
...
![finallyDo](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/finallyDo.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/finallyDo.png)
...
![materialize](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/materialize.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/materialize.c.png)
...
![dematerialize](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/dematerialize.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/dematerialize.c.png)
...
![observeOn](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/observeOn.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/observeOn.c.png)
...
![observeOn](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/observeOn.e.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/observeOn.e.png)
...
![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/serialize.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/serialize.c.png)
...
- Javadoc: [subscribe(Action1,Action1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#subscribe(rx.functions.Action1, rx.functions.Action1))
- Javadoc: [subscribe(Action1,Action1,Action0)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#subscribe(rx.functions.Action1, rx.functions.Action1, rx.functions.Action0))
...
- Javadoc: [forEach(Action1,Action1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#forEach(rx.functions.Action1, rx.functions.Action1))
- Javadoc: [forEach(Action1,Action1,A/Users/mcxiaoke/github/RxDocs/docs/BlockingObservable.mdction0)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#forEach(rx.functions.Action1, rx.functions.Action1, rx.functions.Action0))
...
![SubscribeOn](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/subscribeOn.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/subscribeOn.c.png)
...
![TimeInterval](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeInterval.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeInterval.c.png)
...
![Timeout](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.c.png)

如果原始Observable过了指定的一段时长没有发射任何数据，`Timeout`操作符会以一个`onError`通知终止这个Observable。

RxJava中的实现为`timeout`，但是有好几个变体。

![Timeout](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.1.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.1.png)
...
- Javadoc: [timeout(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timeout(long, java.util.concurrent.TimeUnit))
- Javadoc: [timeout()](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timeout(long, java.util.concurrent.TimeUnit, rx.Scheduler))

![Timeout](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.2.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.2.png)

这个版本的`timeout`在超时时会切换到使用一个你指定的备用的Observable，而不是发错误通知。它也默认在`computation`调度器上执行。

- Javadoc: [timeout(long,TimeUnit,Observable)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timeout(long, java.util.concurrent.TimeUnit, rx.Observable))
- Javadoc: [timeout(long,TimeUnit,Observable,Scheduler)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timeout(long, java.util.concurrent.TimeUnit, rx.Observable, rx.Scheduler))

![Timeout](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.3.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.3.png)
...
![Timeout](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.4.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.4.png)

这个版本的`timeout`同时指定超时时长和备用的Observable。它默认在`immediate`调度器上执行。

- Javadoc: [timeout(Func1,Observable)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timeout(rx.functions.Func1, rx.Observable))

![Timeout](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.5.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.5.png)

这个版本的`time`除了给每一项设置超时，还可以单独给第一项设置一个超时。它默认在`immediate`调度器上执行。

- Javadoc: [timeout(Func0,Func1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timeout(rx.functions.Func0, rx.functions.Func1))

![Timeout](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.6.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timeout.6.png)

同上，但是同时可以指定一个备用的Observable。它默认在`immediate`调度器上执行。

- Javadoc: [timeout(Func0,Func1,Observable)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#timeout(rx.functions.Func0, rx.functions.Func1, rx.Observable))

## Timestamp

给Observable发射的数据项附加一个时间戳

![Timestamp](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timestamp.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/timestamp.c.png)
...
![using](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/using.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/using.c.png)

`Using`操作符让你可以指示Observable创建一个只在它的生命周期内存在的资源，当Observable终止时这个资源会被自动释放。

![using](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/using.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/using.png)
...
- Javadoc: [using(Func0,Func1,Action1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#using(rx.functions.Func0, rx.functions.Func1, rx.functions.Action1))

## To

将Observable转换为另一个对象或数据结构

![to](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/to.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/to.c.png)
...
![getIterator](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/B.getIterator.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/B.getIterator.png)
...
![toFuture](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/B.toFuture.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/B.toFuture.png)
...
![toIterable](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/B.toIterable.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/B.toIterable.png)
...
![toList](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toList.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toList.png)
...
![toMap](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toMap.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toMap.png)
...
- Javadoc: [toMap(Func1,Func1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#toMap(rx.functions.Func1, rx.functions.Func1))
- Javadoc: [toMap(Func1,Func1,Func0)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#toMap(rx.functions.Func1, rx.functions.Func1, rx.functions.Func0))

### toMultiMap

![toMultiMap](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toMultiMap.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toMultiMap.png)
...
- Javadoc: [toMultiMap(Func1,Func1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#toMultimap(rx.functions.Func1, rx.functions.Func1))
- Javadoc: [toMultiMap(Func1,Func1,Func0)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#toMultimap(rx.functions.Func1, rx.functions.Func1, rx.functions.Func0))
- Javadoc: [toMultiMap(Func1,Func1,Func0,Func1)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#toMultimap(rx.functions.Func1, rx.functions.Func1, rx.functions.Func0, rx.functions.Func1))

### toSortedList

![toSortedList](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toSortedList.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/toSortedList.png)
...
![nest](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/nest.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/nest.png)
...
![all](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/all.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/all.c.png)
...
![all](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/all.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/all.png)
...
![amb](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/amb.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/amb.c.png)
...
![amb](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/amb.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/amb.png)
...
![contains](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/contains.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/contains.c.png)

给`Contains`传一个指定的值，如果原始Observable发射了那个值，它返回的Observable将发射true，否则发射false。

相关的一个操作符`IsEmpty`用于判定原始Observable是否没有发射任何数据。

![contains](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/contains.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/contains.png)
...
![exists](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/exists.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/exists.png)
...
![isEmpty](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/isEmpty.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/isEmpty.png)
...
![defaultIfEmtpy](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/defaultIfEmpty.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/defaultIfEmpty.c.png)
...
![sequenceEqual](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sequenceEqual.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sequenceEqual.c.png)

传递两个Observable给`SequenceEqual`操作符，它会比较两个Observable的发射物，如果两个序列是相同的（相同的数据，相同的顺序，相同的终止状态），它就发射true，否则发射false。

![sequenceEqual](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sequenceEqual.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sequenceEqual.png)

它还有一个版本接受第三个参数，可以传递一个函数用于比较两个数据项是否相同。

这个操作符默认不在任何特定的调度器上执行。

- Javadoc: [sequenceEqual(Observable,Observable)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#sequenceEqual(rx.Observable, rx.Observable))
- Javadoc: [sequenceEqual(Observable,Observable,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#sequenceEqual(rx.Observable, rx.Observable, rx.functions.Func2))

## SkipUntil

丢弃原始Observable发射的数据，直到第二个Observable发射了一项数据

![skipUntil](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipUntil.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipUntil.c.png)
...
![skipWhile](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipWhile.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/skipWhile.c.png)
...
![takeUntil](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeUntil.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeUntil.c.png)
...
![takeUntil](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeUntil.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeUntil.png)
...
![takeUntil](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeUntil.p.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeUntil.p.png)
...
![takeWhile](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeWhile.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/takeWhile.c.png)
...
![average](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/average.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/average.c.png)
...
![average](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/average.f.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/average.f.png)
...
![min](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/min.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/min.c.png)

`Min`操作符操作一个发射数值的Observable并发射单个值：最小的那个值。

RxJava中，`min`属于`rxjava-math`模块。

![min](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/min.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/min.png)

`min`接受一个可选参数，用于比较两项数据的大小，如果最小值的数据超过一项，`min`会发射原始Observable最近发射的那一项。

![minBy](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/minBy.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/minBy.png)
...
![max](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/max.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/max.c.png)

`Max`操作符操作一个发射数值的Observable并发射单个值：最大的那个值。

RxJava中，`max`属于`rxjava-math`模块。

![max](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/max.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/max.png)

`max`接受一个可选参数，用于比较两项数据的大小，如果最大值的数据超过一项，`max`会发射原始Observable最近发射的那一项。

![maxBy](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/maxBy.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/maxBy.png)
...
![count](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/count.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/count.c.png)
...
![sum](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sum.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sum.c.png)
...
![sum.f](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sum.f.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/sum.f.png)
...
![concat](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/concat.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/concat.c.png)
...
![concat](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/concat.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/concat.png)

RxJava中的实现叫`concat`。

- Javadoc: [concat(Observable)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#concat(rx.Observable))
- Javadoc: [concat(Observable,Observable) ](http://reactivex.io/RxJava/javadoc/rx/Observable.html#concat(rx.Observable, rx.Observable))
...
![reduce](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/reduce.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/reduce.c.png)
...
![reduce](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/reduce.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/reduce.png)
...
![reduce](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/reduceSeed.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/reduceSeed.png)
...
- Javadoc: [reduce(R,Func2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#reduce(R, rx.functions.Func2))

提示：不建议使用`reduce`收集发射的数据到一个可变的数据结构，那种场景你应该使用`collect`。

![collect](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/collect.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/collect.png)
...
- Javadoc: [collect(Func0,Action2)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#collect(rx.functions.Func0, rx.functions.Action2))
...
![publishConnect](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.png)
...
![connect](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.c.png)
...
![connect](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.png)
...
![publish](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.c.png)
...
![publish](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.png)

RxJava的实现为`publish`。

- Javadoc: [publish()](http://reactivex.io/RxJava/javadoc/rx/Observable.html#publish())

![publish](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.f.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishConnect.f.png)
...
![refCount](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishRefCount.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishRefCount.c.png)
...
![refCount](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishRefCount.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/publishRefCount.png)
...
![replay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/replay.c.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/replay.c.png)
...
![replay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/replay.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/replay.png)
...
- Javadoc: [replay(long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#replay(long, java.util.concurrent.TimeUnit))
- Javadoc: [replay(int,long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#replay(int, long, java.util.concurrent.TimeUnit))

![replay](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/replay.f.png)![img](https://mcxiaoke.gitbooks.io/rxdocs/content/images/operators/replay.f.png)
...
- Javadoc: [replay(Func1,int)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#replay(rx.functions.Func1, int))
- Javadoc: [replay(Func1,long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#replay(rx.functions.Func1, long, java.util.concurrent.TimeUnit))
- Javadoc: [replay(Func1,int,long,TimeUnit)](http://reactivex.io/RxJava/javadoc/rx/Observable.html#replay(rx.functions.Func1, int, long, java.util.concurrent.TimeUnit))
...
如果你的操作符是用于Observable发射的单独的数据项，按照下面的说明做：[*Sequence Operators*](https://mcxiaoke.gitbooks.io/rxdocs/content/topics/Implementing-Your-Own-Operators#序列操作符) 。如果你的操作符是用于变换Observable发射的整个数据序列，按照这个说明做：[*Transformational Operators*](https://mcxiaoke.gitbooks.io/rxdocs/content/topics/Implementing-Your-Own-Operators#变换操作符) 。
